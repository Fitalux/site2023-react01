...
const UnsplashPage = () => {
  ...
  const search = async query => {
    await fetch(
      `https://api.unsplash.com/search/photos?client_id=I7ba-CzsJwZ63mWvfrS0T7KpHn56pL6ett68uoeQtIw&query=${query}&per_page=30`,
    )
  ...
  useEffect(() => {
    ...
    fetch(
      'https://api.unsplash.com/photos?client_id=I7ba-CzsJwZ63mWvfrS0T7KpHn56pL6ett68uoeQtIw&per_page=30',
      requestOptions,
    )
      .then(response => response.json())
